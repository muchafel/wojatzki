...
import dataInspection.WordStanceAnnoInspector;
...
public class StancePolarityAnnoTest {
    ...
    public void pipeLine() throws Exception {
		...
		AnalysisEngineDescription inspection=  createEngineDescription(WordStanceAnnoInspector.class);
		
		SimplePipeline.runPipeline(reader, PreprocessingPipeline.getPreprocessingTokenStanceAnno(),inspection);
	}
