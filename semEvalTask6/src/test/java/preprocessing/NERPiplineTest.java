...
import dataInspection.PreprocessingNERInspector;
...
public class NERPiplineTest {
    ...
    public void pipeLine3() throws Exception {
		...
		AnalysisEngineDescription inspection=  createEngineDescription(PreprocessingNERInspector.class);
		
		SimplePipeline.runPipeline(reader, PreprocessingPipeline.getPreprocessingNER(),inspection);
	}
