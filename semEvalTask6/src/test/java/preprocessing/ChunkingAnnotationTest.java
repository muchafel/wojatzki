...
public class ChunkingAnnotationTest {
    ...
    public void pipeLine() throws Exception {
		...
		AnalysisEngineDescription inspection=  createEngineDescription(ChunkingAnnotationInspector.class);
		
		SimplePipeline.runPipeline(reader, PreprocessingPipeline.getPreprocessingChunkingFunctionalStanceAnno(),inspection);
	}
