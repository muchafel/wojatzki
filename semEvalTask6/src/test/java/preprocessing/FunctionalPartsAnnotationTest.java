...
public class FunctionalPartsAnnotationTest {
    ...
    public void pipeLine() throws Exception {
		...
		AnalysisEngineDescription inspection=  createEngineDescription(FunctionalPartsAnnotationInspector.class);
		
		SimplePipeline.runPipeline(reader, PreprocessingPipeline.getPreprocessingFunctionalStanceAnno(),inspection);
	}
