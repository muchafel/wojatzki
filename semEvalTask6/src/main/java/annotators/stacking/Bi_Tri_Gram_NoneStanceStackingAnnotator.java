...
public class Bi_Tri_Gram_NoneStanceStackingAnnotator extends JCasAnnotator_ImplBase {

	public static final String PARAM_TC_MODEL_LOCATION = "Bi_Tri_Gram_NoneStanceModel";
	@ConfigurationParameter(name = PARAM_TC_MODEL_LOCATION, mandatory = true)
	protected File tcModelLocation;

	public static final String PARAM_TC_READER = "BiGramStackingNoneStanceWithTCReader";
...
//		System.out.println("classified "+JCasUtil.selectSingle(jcas, TextClassificationOutcome.class).getOutcome());
		// annotate
		BiTriGramOutcomeStanceNone annotation = new BiTriGramOutcomeStanceNone(jcas);
