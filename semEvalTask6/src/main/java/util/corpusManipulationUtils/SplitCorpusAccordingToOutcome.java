...
public class SplitCorpusAccordingToOutcome {
	...
	public static void main(String[] args) throws IOException, ResourceInitializationException {
		...
		for (JCas jcas : new JCasIterable(reader)) {
			...
			if(outcome.equals("FAVOR")||outcome.equals("AGAINST")){
				...
				createFolder(baseDir+"/semevalTask6/favorVsAgainst","all");
				String newFile= baseDir+"/semevalTask6/favorVsAgainst/all/"+fileName;
