 ...
 * @generated */
public class WorkOfArt extends NamedEntity {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected WorkOfArt() {/* intentionally empty block */}
   ...
   */
  public WorkOfArt(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public WorkOfArt(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
