 ...
 * @generated */
public class COMPLM extends Dependency {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected COMPLM() {/* intentionally empty block */}
   ...
   */
  public COMPLM(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public COMPLM(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
