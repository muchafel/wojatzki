 ...
 * @generated */
public class CSUBJPASS extends Dependency {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected CSUBJPASS() {/* intentionally empty block */}
   ...
   */
  public CSUBJPASS(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public CSUBJPASS(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
