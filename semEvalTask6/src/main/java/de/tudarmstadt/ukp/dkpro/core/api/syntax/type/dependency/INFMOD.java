 ...
 * @generated */
public class INFMOD extends Dependency {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected INFMOD() {/* intentionally empty block */}
   ...
   */
  public INFMOD(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public INFMOD(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
