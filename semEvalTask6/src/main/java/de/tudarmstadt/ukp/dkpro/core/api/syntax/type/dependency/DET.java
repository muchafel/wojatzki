 ...
 * @generated */
public class DET extends Dependency {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected DET() {/* intentionally empty block */}
   ...
   */
  public DET(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public DET(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
