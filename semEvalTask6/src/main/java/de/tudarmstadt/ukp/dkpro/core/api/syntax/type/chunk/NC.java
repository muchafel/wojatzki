 ...
 * @generated */
public class NC extends Chunk {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(NC.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected NC() {/* intentionally empty block */}
   ...
   */
  public NC(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public NC(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
