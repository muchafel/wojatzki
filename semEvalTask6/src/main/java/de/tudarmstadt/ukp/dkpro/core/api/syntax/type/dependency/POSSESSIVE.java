 ...
 * @generated */
public class POSSESSIVE extends Dependency {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected POSSESSIVE() {/* intentionally empty block */}
   ...
   */
  public POSSESSIVE(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public POSSESSIVE(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
