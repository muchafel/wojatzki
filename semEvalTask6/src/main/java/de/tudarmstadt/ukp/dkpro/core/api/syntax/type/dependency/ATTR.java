 ...
 * @generated */
public class ATTR extends Dependency {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected ATTR() {/* intentionally empty block */}
   ...
   */
  public ATTR(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public ATTR(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
