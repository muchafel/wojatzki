 ...
 * @generated */
public class PRECONJ extends Dependency {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected PRECONJ() {/* intentionally empty block */}
   ...
   */
  public PRECONJ(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public PRECONJ(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
