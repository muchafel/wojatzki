 ...
 * @generated */
public class POBJ extends Dependency {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected POBJ() {/* intentionally empty block */}
   ...
   */
  public POBJ(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public POBJ(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
