 ...
 * @generated */
public class TMOD extends Dependency {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected TMOD() {/* intentionally empty block */}
   ...
   */
  public TMOD(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public TMOD(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
