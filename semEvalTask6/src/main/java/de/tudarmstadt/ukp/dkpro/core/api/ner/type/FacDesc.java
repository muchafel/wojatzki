 ...
 * @generated */
public class FacDesc extends NamedEntity {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected FacDesc() {/* intentionally empty block */}
   ...
   */
  public FacDesc(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public FacDesc(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
