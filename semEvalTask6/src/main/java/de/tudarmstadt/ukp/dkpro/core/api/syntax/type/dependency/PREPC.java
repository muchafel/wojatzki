 ...
 * @generated */
public class PREPC extends Dependency {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected PREPC() {/* intentionally empty block */}
   ...
   */
  public PREPC(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public PREPC(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
