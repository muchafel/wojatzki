 ...
 * @generated */
public class CONJ_YET extends Dependency {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected CONJ_YET() {/* intentionally empty block */}
   ...
   */
  public CONJ_YET(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public CONJ_YET(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
