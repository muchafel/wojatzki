 ...
 * @generated */
public class POSS extends Dependency {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected POSS() {/* intentionally empty block */}
   ...
   */
  public POSS(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public POSS(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
