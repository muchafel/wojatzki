 ...
 * @generated */
public class AUXPASS extends Dependency {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected AUXPASS() {/* intentionally empty block */}
   ...
   */
  public AUXPASS(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public AUXPASS(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
