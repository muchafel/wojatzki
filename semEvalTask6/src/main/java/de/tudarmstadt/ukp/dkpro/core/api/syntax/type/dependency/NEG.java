 ...
 * @generated */
public class NEG extends Dependency {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected NEG() {/* intentionally empty block */}
   ...
   */
  public NEG(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public NEG(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
