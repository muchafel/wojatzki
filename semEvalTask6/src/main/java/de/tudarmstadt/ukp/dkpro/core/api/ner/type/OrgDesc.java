 ...
 * @generated */
public class OrgDesc extends NamedEntity {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected OrgDesc() {/* intentionally empty block */}
   ...
   */
  public OrgDesc(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public OrgDesc(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
