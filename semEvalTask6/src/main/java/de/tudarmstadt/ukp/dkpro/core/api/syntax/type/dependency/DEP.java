 ...
 * @generated */
public class DEP extends Dependency {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected DEP() {/* intentionally empty block */}
   ...
   */
  public DEP(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public DEP(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
