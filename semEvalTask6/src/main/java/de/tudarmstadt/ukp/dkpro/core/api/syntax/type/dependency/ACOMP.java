 ...
 * @generated */
public class ACOMP extends Dependency {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected ACOMP() {/* intentionally empty block */}
   ...
   */
  public ACOMP(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public ACOMP(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
