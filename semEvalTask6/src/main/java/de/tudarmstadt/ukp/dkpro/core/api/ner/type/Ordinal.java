 ...
 * @generated */
public class Ordinal extends NamedEntity {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected Ordinal() {/* intentionally empty block */}
   ...
   */
  public Ordinal(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Ordinal(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
