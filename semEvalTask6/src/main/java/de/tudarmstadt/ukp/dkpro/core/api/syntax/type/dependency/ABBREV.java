 ...
 * @generated */
public class ABBREV extends Dependency {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected ABBREV() {/* intentionally empty block */}
   ...
   */
  public ABBREV(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public ABBREV(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
