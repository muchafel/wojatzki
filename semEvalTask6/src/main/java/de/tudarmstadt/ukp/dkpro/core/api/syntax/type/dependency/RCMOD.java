 ...
 * @generated */
public class RCMOD extends Dependency {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected RCMOD() {/* intentionally empty block */}
   ...
   */
  public RCMOD(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public RCMOD(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
