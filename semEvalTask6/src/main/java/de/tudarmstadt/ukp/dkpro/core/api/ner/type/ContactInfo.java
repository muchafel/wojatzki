 ...
 * @generated */
public class ContactInfo extends NamedEntity {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected ContactInfo() {/* intentionally empty block */}
   ...
   */
  public ContactInfo(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public ContactInfo(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
