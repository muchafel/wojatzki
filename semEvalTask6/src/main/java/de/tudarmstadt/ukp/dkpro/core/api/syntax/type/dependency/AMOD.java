 ...
 * @generated */
public class AMOD extends Dependency {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected AMOD() {/* intentionally empty block */}
   ...
   */
  public AMOD(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public AMOD(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
