 ...
 * @generated */
public class Fac extends NamedEntity {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected Fac() {/* intentionally empty block */}
   ...
   */
  public Fac(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Fac(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
