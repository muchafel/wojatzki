 ...
 * @generated */
public class RRC extends Constituent {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected RRC() {/* intentionally empty block */}
   ...
   */
  public RRC(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public RRC(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
