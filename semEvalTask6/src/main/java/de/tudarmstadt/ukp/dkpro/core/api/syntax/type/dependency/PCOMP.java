 ...
 * @generated */
public class PCOMP extends Dependency {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected PCOMP() {/* intentionally empty block */}
   ...
   */
  public PCOMP(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public PCOMP(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
