 ...
 * @generated */
public class PREP extends Dependency {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected PREP() {/* intentionally empty block */}
   ...
   */
  public PREP(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public PREP(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
