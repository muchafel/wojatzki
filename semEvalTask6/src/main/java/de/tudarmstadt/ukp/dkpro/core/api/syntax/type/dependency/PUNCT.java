 ...
 * @generated */
public class PUNCT extends Dependency {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected PUNCT() {/* intentionally empty block */}
   ...
   */
  public PUNCT(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public PUNCT(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
