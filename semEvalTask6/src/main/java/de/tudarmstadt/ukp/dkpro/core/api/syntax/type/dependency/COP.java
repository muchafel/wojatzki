 ...
 * @generated */
public class COP extends Dependency {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected COP() {/* intentionally empty block */}
   ...
   */
  public COP(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public COP(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
