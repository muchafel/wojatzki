 ...
 * @generated */
public class ADVCL extends Dependency {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected ADVCL() {/* intentionally empty block */}
   ...
   */
  public ADVCL(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public ADVCL(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
