 ...
 * @generated */
public class ADVMOD extends Dependency {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected ADVMOD() {/* intentionally empty block */}
   ...
   */
  public ADVMOD(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public ADVMOD(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
