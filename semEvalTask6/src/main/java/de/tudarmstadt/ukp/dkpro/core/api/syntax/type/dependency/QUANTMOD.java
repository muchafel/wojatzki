 ...
 * @generated */
public class QUANTMOD extends Dependency {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected QUANTMOD() {/* intentionally empty block */}
   ...
   */
  public QUANTMOD(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public QUANTMOD(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
