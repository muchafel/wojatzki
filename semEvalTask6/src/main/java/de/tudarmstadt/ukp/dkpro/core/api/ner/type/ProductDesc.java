 ...
 * @generated */
public class ProductDesc extends NamedEntity {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected ProductDesc() {/* intentionally empty block */}
   ...
   */
  public ProductDesc(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public ProductDesc(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
