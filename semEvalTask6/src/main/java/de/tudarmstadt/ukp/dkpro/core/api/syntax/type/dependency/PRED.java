 ...
 * @generated */
public class PRED extends Dependency {
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected PRED() {/* intentionally empty block */}
   ...
   */
  public PRED(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public PRED(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
