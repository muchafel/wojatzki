...
lstmUnitsConfigs=[138]
#defualt softmax
activations=['tanh','sigmoid','relu','softmax']
for lstmConfig in lstmUnitsConfigs:
    for activation in activations:
        for optimizer in optimizers:
            ...
            for i in range(0, len(predictions)):
                ...
                with open("/Users/michael/git/ucsm_git/stance_lstm/result/activation"+activation+"optimizer"+optimizer+"_lstmUnits_"+str(lstm_units)+"result_w_dropout_numberEpochs"+str(numberEpochs)+".txt", "a+") as file:
