  ...
  */  
  ...
  public String getStance() {
    if (StanceAnnotation_Type.featOkTst && ((StanceAnnotation_Type)jcasType).casFeat_stance == null)
      jcasType.jcas.throwFeatMissing("stance", "de.uni.due.ltl.interactiveStance.types.StanceAnnotation");
  ...
  public String getTarget() {
    if (StanceAnnotation_Type.featOkTst && ((StanceAnnotation_Type)jcasType).casFeat_target == null)
      jcasType.jcas.throwFeatMissing("target", "de.uni.due.ltl.interactiveStance.types.StanceAnnotation");
  ...
  public String getOriginalId() {
    if (StanceAnnotation_Type.featOkTst && ((StanceAnnotation_Type)jcasType).casFeat_originalId == null)
      jcasType.jcas.throwFeatMissing("originalId", "de.uni.due.ltl.interactiveStance.types.StanceAnnotation");
