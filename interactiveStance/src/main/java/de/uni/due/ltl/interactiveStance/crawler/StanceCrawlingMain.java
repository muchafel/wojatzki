...
//		crawlerFleet.getCrawlers().add(new CreateDebateDOTCOMCrawler("http://www.createdebate.com/browse/debates", null));
//		crawlerFleet.getCrawlers().add(new CreateDebateDOTCOMCrawler("http://www.createdebate.com/browse/debates", new File("/Users/michael/git/ucsm_git/interactiveStance/createDebateLinks.txt")));
//		crawlerFleet.getCrawlers().add(new ForAndAgainstDOTCOMCrawler("http://www.forandagainst.com/",new File("/Users/michael/git/ucsm_git/interactiveStance/favorAgainstLinks.txt"),true));
		crawlerFleet.getCrawlers().add(new DebateWiseDOTORGCrawler("http://debatewise.org/", null));
