...
//			"Witnessing Death Penalty can have a negative impact on humans psyche (e.g. for the executioner)"
	...
	public static ArrayList<String> targets_Set2 = new ArrayList<String>(Arrays.asList(
//			"Execution helps alleviate the overcrowding of prisons.",	
	...
	public static ArrayList<String> nonTextualReference = new ArrayList<String>(Arrays.asList("Video"
			,"Foreigen Source"
			));
