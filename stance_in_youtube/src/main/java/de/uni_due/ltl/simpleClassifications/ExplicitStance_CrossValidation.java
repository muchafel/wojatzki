...
//			experiment.runCrossValidation(pSpace, "debateNgram_oracle_RecurrentAuthor");
			...
			for (String explicitTarget : targets_Set2) {
				...
				ParameterSpace pSpace_explicit = experiment.setupCrossValidation(baseDir + "/youtubeStance/corpus_minorityVote/bin/", explicitTarget, "2", featureSet);
			...
			for (String explicitTarget : targets_Set1) {
				...
				System.out.println(experimentName);
				System.out.println();
				ParameterSpace pSpace_explicit = experiment.setupCrossValidation(baseDir + "/youtubeStance/corpus_minorityVote/bin/", explicitTarget,"1",featureSet);
				experiment.runCrossValidation(pSpace_explicit, "stanceExperiment_" + experimentName);
			}
...
//		}
		...
		public ParameterSpace setupCrossValidation(String dataLocation, String target, String targetSet, TcFeatureSet featureSet) throws ResourceInitializationException {
		...
		private Map<String, Object> getDimReaders(String dir, String target, String targetSet) throws ResourceInitializationException {
			...
			dimReaders.put(DIM_READER_TRAIN, CollectionReaderFactory.createReaderDescription(YouTubeReader.class, YouTubeReader.PARAM_SOURCE_LOCATION, inputTrainFolder, YouTubeReader.PARAM_LANGUAGE,
					LANGUAGE_CODE, YouTubeReader.PARAM_PATTERNS, "*.bin", YouTubeReader.PARAM_TARGET_LABEL,target, YouTubeReader.PARAM_TARGET_SET,targetSet));
