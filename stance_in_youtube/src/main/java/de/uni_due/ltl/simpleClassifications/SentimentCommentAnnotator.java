...
public class SentimentCommentAnnotator extends JCasAnnotator_ImplBase{
...
//		Collection<Sentence> dkproSentences = JCasUtil.select(jcas, Sentence.class);
		...
		if (comments.isEmpty()) {
			throw new AnalysisEngineProcessException(new IllegalArgumentException("No comments in jcas"));
		}
