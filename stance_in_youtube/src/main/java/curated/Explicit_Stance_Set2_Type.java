...
public class Explicit_Stance_Set2_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("curated.Explicit_Stance_Set2");
  ...
  public String getPolarity(int addr) {
      ...
      jcas.throwFeatMissing("Polarity", "curated.Explicit_Stance_Set2");
  ...
  public String getTarget(int addr) {
      ...
      jcas.throwFeatMissing("Target", "curated.Explicit_Stance_Set2");
