...
public class NonTextual_Content_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("webanno.custom.NonTextual_Content");
  ...
  public String getSource(int addr) {
      ...
      jcas.throwFeatMissing("Source", "webanno.custom.NonTextual_Content");
