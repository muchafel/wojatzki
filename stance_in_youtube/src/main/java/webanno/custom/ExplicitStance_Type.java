 ...
 * @generated */
public class ExplicitStance_Type extends Annotation_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (ExplicitStance_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = ExplicitStance_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new ExplicitStance(addr, ExplicitStance_Type.this);
  			   ExplicitStance_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new ExplicitStance(addr, ExplicitStance_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = ExplicitStance.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("webanno.custom.ExplicitStance");
  ...
  public String getPolarity(int addr) {
      ...
      jcas.throwFeatMissing("Polarity", "webanno.custom.ExplicitStance");
  ...
  public String getTarget(int addr) {
      ...
      jcas.throwFeatMissing("Target", "webanno.custom.ExplicitStance");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public ExplicitStance_Type(JCas jcas, Type casType) {
    super(jcas, casType);
