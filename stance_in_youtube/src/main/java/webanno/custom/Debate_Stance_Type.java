...
public class Debate_Stance_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("webanno.custom.Debate_Stance");
  ...
  public String getPolarity(int addr) {
      ...
      jcas.throwFeatMissing("Polarity", "webanno.custom.Debate_Stance");
