...
public class NonTextual_Content_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("rawTypes.NonTextual_Content");
  ...
  public String getSource(int addr) {
      ...
      jcas.throwFeatMissing("Source", "rawTypes.NonTextual_Content");
  ...
  public String getAnnotator(int addr) {
      ...
      jcas.throwFeatMissing("Annotator", "rawTypes.NonTextual_Content");
