...
public class Direct_Insult_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("rawTypes.Direct_Insult");
  ...
  public String getInsultTarget(int addr) {
      ...
      jcas.throwFeatMissing("InsultTarget", "rawTypes.Direct_Insult");
  ...
  public String getAnnotator(int addr) {
      ...
      jcas.throwFeatMissing("Annotator", "rawTypes.Direct_Insult");
