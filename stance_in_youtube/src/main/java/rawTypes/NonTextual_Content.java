  ...
  */  
  ...
  public String getSource() {
    if (NonTextual_Content_Type.featOkTst && ((NonTextual_Content_Type)jcasType).casFeat_Source == null)
      jcasType.jcas.throwFeatMissing("Source", "rawTypes.NonTextual_Content");
  ...
  public String getAnnotator() {
    if (NonTextual_Content_Type.featOkTst && ((NonTextual_Content_Type)jcasType).casFeat_Annotator == null)
      jcasType.jcas.throwFeatMissing("Annotator", "rawTypes.NonTextual_Content");
    return jcasType.ll_cas.ll_getStringValue(addr, ((NonTextual_Content_Type)jcasType).casFeatCode_Annotator);}
  ...
  public void setAnnotator(String v) {
    if (NonTextual_Content_Type.featOkTst && ((NonTextual_Content_Type)jcasType).casFeat_Annotator == null)
      jcasType.jcas.throwFeatMissing("Annotator", "rawTypes.NonTextual_Content");
    jcasType.ll_cas.ll_setStringValue(addr, ((NonTextual_Content_Type)jcasType).casFeatCode_Annotator, v);}    
  }
