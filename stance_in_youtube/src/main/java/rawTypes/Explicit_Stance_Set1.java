  ...
  */  
  ...
  public String getPolarity() {
    if (Explicit_Stance_Set1_Type.featOkTst && ((Explicit_Stance_Set1_Type)jcasType).casFeat_Polarity == null)
      jcasType.jcas.throwFeatMissing("Polarity", "rawTypes.Explicit_Stance_Set1");
  ...
  public String getTarget() {
    if (Explicit_Stance_Set1_Type.featOkTst && ((Explicit_Stance_Set1_Type)jcasType).casFeat_Target == null)
      jcasType.jcas.throwFeatMissing("Target", "rawTypes.Explicit_Stance_Set1");
  ...
  public String getAnnotator() {
    if (Explicit_Stance_Set1_Type.featOkTst && ((Explicit_Stance_Set1_Type)jcasType).casFeat_Annotator == null)
      jcasType.jcas.throwFeatMissing("Annotator", "rawTypes.Explicit_Stance_Set1");
    return jcasType.ll_cas.ll_getStringValue(addr, ((Explicit_Stance_Set1_Type)jcasType).casFeatCode_Annotator);}
  ...
  public void setAnnotator(String v) {
    if (Explicit_Stance_Set1_Type.featOkTst && ((Explicit_Stance_Set1_Type)jcasType).casFeat_Annotator == null)
      jcasType.jcas.throwFeatMissing("Annotator", "rawTypes.Explicit_Stance_Set1");
    jcasType.ll_cas.ll_setStringValue(addr, ((Explicit_Stance_Set1_Type)jcasType).casFeatCode_Annotator, v);}    
  }
