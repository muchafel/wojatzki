...
public class Explicit_Stance_Set1_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("rawTypes.Explicit_Stance_Set1");
  ...
  public String getPolarity(int addr) {
      ...
      jcas.throwFeatMissing("Polarity", "rawTypes.Explicit_Stance_Set1");
  ...
  public String getTarget(int addr) {
      ...
      jcas.throwFeatMissing("Target", "rawTypes.Explicit_Stance_Set1");
  ...
  public String getAnnotator(int addr) {
      ...
      jcas.throwFeatMissing("Annotator", "rawTypes.Explicit_Stance_Set1");
