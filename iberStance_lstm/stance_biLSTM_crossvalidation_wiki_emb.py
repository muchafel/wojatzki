...
for file in leave_out_Files:
    ...
    for i in range(0, len(predictions)):
        ...
        with open("result/cv_wiki/"+language+"_batchsize_"+str(batchsize)+"_activation_"+str(activation)+"_opimizer"+str(optimizer)+"_lstmUnits_"+str(lstm_units)+"result_dropout_"+str(dropout)+"_epochs_numberEpochs"+str(numberEpochs)+'_lossFunction_'+str(lossFunction)+"_plusDropout_.txt", "a+") as file:
                                file.write(str(gold)+"\t"+str(predicted)+"\n")

        with open("result/cv_wiki/"+language+"_batchsize_"+str(batchsize)+"_activation_"+str(activation)+"_opimizer"+str(optimizer)+"_lstmUnits_"+str(lstm_units)+"result_dropout_"+str(dropout)+"_epochs_numberEpochs"+str(numberEpochs)+'_lossFunction_'+str(lossFunction)+"_plusDropout_id2Outcome.txt", "a+") as file2:
