...
lstmUnitsConfigs=[48,64,138,123,100,125,200,68,300,400]
#default softmax
                ...
                for lossFunction in loss_functions:
                    ...
                    for file in leave_out_Files:
                        ...
                        for i in range(0, len(predictions)):
                            ...
                            with open("result/cv2/"+language+"_activation_"+str(activation)+"_opimizer"+str(optimizer)+"_lstmUnits_"+str(lstm_units)+"result_dropout_"+str(dropout)+"_epochs_numberEpochs"+str(numberEpochs)+'_lossFunction_'+str(lossFunction)+".txt", "a+") as file:
                                file.write(str(gold)+"\t"+str(predicted)+"\n")

                            with open("result/cv2/"+language+"_activation_"+str(activation)+"_opimizer"+str(optimizer)+"_lstmUnits_"+str(lstm_units)+"result_dropout_"+str(dropout)+"_epochs_numberEpochs"+str(numberEpochs)+'_lossFunction_'+str(lossFunction)+"_id2Outcome.txt", "a+") as file2:
