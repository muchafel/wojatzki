 ...
 * @generated */
public class MainTarget_Type extends Annotation_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (MainTarget_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = MainTarget_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new MainTarget(addr, MainTarget_Type.this);
  			   MainTarget_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new MainTarget(addr, MainTarget_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = MainTarget.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("consolidatedTypes.MainTarget");
  ...
  public String getTarget(int addr) {
      ...
      jcas.throwFeatMissing("target", "consolidatedTypes.MainTarget");
  ...
  public String getPolarity(int addr) {
      ...
      jcas.throwFeatMissing("polarity", "consolidatedTypes.MainTarget");
  ...
  public String getAnnotator(int addr) {
      ...
      jcas.throwFeatMissing("annotator", "consolidatedTypes.MainTarget");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public MainTarget_Type(JCas jcas, Type casType) {
    super(jcas, casType);
