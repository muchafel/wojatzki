...
public class Irony extends Annotation {
  ...
  */  
  ...
  public String getAnnotator() {
    if (Irony_Type.featOkTst && ((Irony_Type)jcasType).casFeat_annotator == null)
      jcasType.jcas.throwFeatMissing("annotator", "consolidatedTypes.Irony");
    return jcasType.ll_cas.ll_getStringValue(addr, ((Irony_Type)jcasType).casFeatCode_annotator);}
  ...
  public void setAnnotator(String v) {
    if (Irony_Type.featOkTst && ((Irony_Type)jcasType).casFeat_annotator == null)
      jcasType.jcas.throwFeatMissing("annotator", "consolidatedTypes.Irony");
    jcasType.ll_cas.ll_setStringValue(addr, ((Irony_Type)jcasType).casFeatCode_annotator, v);}    
  }
