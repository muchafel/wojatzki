 ...
 * @generated */
public class CuratedSubTarget_Type extends Annotation_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (CuratedSubTarget_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = CuratedSubTarget_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new CuratedSubTarget(addr, CuratedSubTarget_Type.this);
  			   CuratedSubTarget_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new CuratedSubTarget(addr, CuratedSubTarget_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = CuratedSubTarget.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("curatedTypes.CuratedSubTarget");
  ...
  public String getTarget(int addr) {
      ...
      jcas.throwFeatMissing("target", "curatedTypes.CuratedSubTarget");
  ...
  public String getPolarity(int addr) {
      ...
      jcas.throwFeatMissing("polarity", "curatedTypes.CuratedSubTarget");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public CuratedSubTarget_Type(JCas jcas, Type casType) {
    super(jcas, casType);
