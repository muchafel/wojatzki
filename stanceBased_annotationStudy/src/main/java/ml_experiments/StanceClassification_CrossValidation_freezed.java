...
/**
 * class freezed to document results for experiments in paper DO NOT MODIFY!
 * class for executing machine learning experiments on stance data 
 * configuration options are marked with an X
 * @author michael
 *
 */
public class StanceClassification_CrossValidation_freezed implements Constants {
	...
	public static void main(String[] args) throws Exception {
		...
		StanceClassification_CrossValidation_freezed experiment = new StanceClassification_CrossValidation_freezed();
