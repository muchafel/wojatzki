...
public class StanceClassification_TrainTest implements Constants {
	...
	// ngram (char + word) stacked: .56 / .37 (klassifiziert nichts als FAVOR ;// char und word ngramme trennen? getrennt: .55 / .36)
...
//		 experiment.saveModel(experiment.setup(baseDir,"ATHEISM"),
		// subTarget,subTarget.replace(" ", "")+"_saveModel");
		// }
