...
public class translateId2OutcomeFile {
	public static void main(String[] args) throws IOException {
		...
		for(String id2outcomes: FileUtils.readLines(new File("src/main/resources/similarityPredicted/snn:id2Outcome2.txt"), "UTF-8")) {
			...
			FileUtils.write(new File("src/main/resources/similarityPredicted/snn:id2Outcome_translated_2.txt"), newline+"\n", "UTF-8", true);
