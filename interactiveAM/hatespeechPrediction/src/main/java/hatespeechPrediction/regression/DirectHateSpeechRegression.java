...
public class DirectHateSpeechRegression implements Constants {
	...
	public TcFeatureSet featureSet = new TcFeatureSet(
			 TcFeatureFactory.create(
					 WordNGram.class,
					 WordNGram.PARAM_NGRAM_USE_TOP_K,
			 N_GRAM_MAXCANDIDATES,
			 WordNGram.PARAM_NGRAM_MIN_N, WORD_N_GRAM_MIN,
			 WordNGram.PARAM_NGRAM_MAX_N, WORD_N_GRAM_MAX),
			 TcFeatureFactory.create(
					 CharacterNGram.class,
					 CharacterNGram.PARAM_NGRAM_USE_TOP_K,
			 N_GRAM_MAXCANDIDATES,
			 CharacterNGram.PARAM_NGRAM_MIN_N, CHAR_N_GRAM_MIN,
	...
	public static void main(String[] args) throws Exception {
		...
		DirectHateSpeechRegression experiment = new DirectHateSpeechRegression();

		// XXX CV for getting the id2outcome file for the DFE
		ParameterSpace pSpace = experiment.setupCrossValidation("/Users/michael/Dropbox/gender_hatespeech_corpus/results/MLData.tsv", "HateSpeech");
