...
public class Id2OutcomeUtil {
    ...
    public static Map<String, Boolean> getId2Correct(String path, boolean isSVM) throws ResourceInitializationException {
		Map<String, Boolean> id2Outcome = new HashMap<String, Boolean>();
		List<String> labels=null;
		try (BufferedReader br = new BufferedReader(new FileReader(path))) {
			String line = null;
	...
	public static Map<String, Integer> getId2GoldMap_String(String path) throws ResourceInitializationException {
		Map<String, Integer> id2Outcome = new HashMap<String, Integer>();
		List<String> labels=null;
		try (BufferedReader br = new BufferedReader(new FileReader(path))) {
			String line = null;
