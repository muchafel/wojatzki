...
public class PrepareDL_Data {
	...
	public static void main(String[] args) throws IOException, UIMAException {
		...
		create10FoldTxtCorpus(new File("src/main/resources/corpus"), tokenizerEngine, reader);
...
//		System.out.println(md.getDocumentId());
	...
	private static CharSequence getWhitespaceSpearatedTokens(JCas jcas) {
