...
public class AgreementRegression implements Constants{
	 ...
	 * we should do some experiments using the standard fetaures from dkpro-tc
	 */
...
//			TcFeatureFactory.create(WordEmbeddingDFE.class,WordEmbeddingDFE.PARAM_WORDEMBEDDINGLOCATION, "/Users/michael/git/lang-tech-teaching/de.unidue.kbs/src/main/resources/GloVe/glove.twitter.27B.200d.txt")
//			TcFeatureFactory.create(NrOfTokens.class)
	...
	public static void main(String[] args) throws Exception {
		...
		ParameterSpace pSpace = experiment.setupCrossValidation("src/main/resources/data/data.tsv","Passion");
		experiment.runCrossValidation(pSpace, "svm_passion_sentiment");
	...
	protected AnalysisEngineDescription getPreprocessing()
	        ...
	        return createEngineDescription(createEngineDescription(BreakIteratorSegmenter.class),createEngineDescription(StanfordSentimentAnnotator.class));
	}
