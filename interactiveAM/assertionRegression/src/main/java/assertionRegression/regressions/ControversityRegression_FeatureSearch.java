...
public class ControversityRegression_FeatureSearch implements Constants {
	...
	public static void main(String[] args) throws Exception {
		...
		ControversityRegression_FeatureSearch experiment = new ControversityRegression_FeatureSearch();
...
//				TcFeatureFactory.create(AdjEndingFeatureExtractor.class),
		...
		for(String featureSet: variants.keySet()) {
			...
			ParameterSpace pSpace = experiment.setupCrossValidation(baseDir+"/UCI/data/data.tsv", "Controversity",variants.get(featureSet));
			experiment.runCrossValidation(pSpace, featureSet+"_controversity");
		}
